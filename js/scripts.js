$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        options: {
            class: '',
            // If ID string is null, one will be generated
            id: ''
        },
        data: {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '21e012ef7e2398c110b1e2cf86d0d165') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbyIvLEzTAnbRumfoNo4woxlAd7c3eaqjO_ZBZ30IsO_raSPfPj0xAa_X5VT2dHRXm7B/exec', data)
                .done(function (data) {
                    console.log(data);
...
// Google map
function initMap() {
    var location = { lat: -33.850766, lng: 150.642711 };
...
function initBBSRMap() {
    var la_fiesta = { lat: -33.850766, lng: 150.642711 };
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
